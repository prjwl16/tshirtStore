...
exports.createProduct = (req, res) => {
    ...
    form.parse(req, (err, fields, file) => {
        ...
        console.log("fldssssssss",fields)
        console.log("ileeeeeeeeeeeeee",file)
            return res.status(400).json({
                msg: "Faileddddd"
            })
        }
...
exports.updateProduct = (req, res) => {
    ...
    form.parse(req, (err, fields, file) => {
        ...
        let product = req.product
        console.log("reqqqqqqqqq",req.product)
        console.log("ffffffff",fields)
